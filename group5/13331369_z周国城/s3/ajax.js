(function(){
  var Button, addClickEventToAButtons, addSumToBubble, addClickEventToAllButtons, addTheFetchNumberToSum, addLeaveEventToTheArea, reset, resetForBubble, robot;
  Button = (function(){
    ...
    function Button(dom, goodMessages, badMessages, next, numberFetchBack){
      var this$ = this;
      this.dom = dom;
      ...
      this.dom.click(function(){
        ...
        this$.fetchNumberAndShow(this$.name);
    ...
    prototype.fetchNumberAndShow = function(name){
      var this$ = this;
      $.get('/' + name, function(number, result){
        this$.done();
  ...
  addClickEventToAllButtons = function(next){
    ...
    function fn$(i, dom){
      new Button($(dom), goodMessages[i], badMessages[i], next, function(error, number){
        if (error) {
  ...
  robot = {
    ...
    nextToClick: function(){
      if (this.numberHasClick < 5) {
        this.button[this.numberHasClick++].click();
      }
    }
  };
}).call(this);
