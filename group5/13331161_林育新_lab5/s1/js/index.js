...
(function(){
  var init, addNumberToAllButtonClick, disableAllOtherButton, pullRequerstToServerAndShowNumber, calculate, enableAllOtherButton, allButtonIsDone, addResultToBubble, addResetToApbMouseleave;
  $(function(){
    init();
    addNumberToAllButtonClick();
    return addResetToApbMouseleave();
  });
  init = function(){
    var i$, ref$, len$, btn;
